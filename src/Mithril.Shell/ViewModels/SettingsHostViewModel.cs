...
public sealed partial class SettingsHostViewModel : ObservableObject
{
    ...
    public SettingsHostViewModel(IServiceProvider services, IEnumerable<IMithrilModule> modules)
    {
        _services = services;
        ...
        Sections.Add(new SettingsSection
        {
            ...
            IconUri = "pack://application:,,,/Mithril;component/Resources/game-folder.ico",
        });
        Sections.Add(new SettingsSection
        {
            ...
            IconUri = "pack://application:,,,/Mithril;component/Resources/reference-data.ico",
        });
        Sections.Add(new SettingsSection
        {
            Title = "Icons",
            ...
            IconUri = "pack://application:,,,/Mithril;component/Resources/icons.ico",
        });
        Sections.Add(new SettingsSection
        {
            Title = "Appearance",
            ...
            IconUri = "pack://application:,,,/Mithril;component/Resources/appearance.ico",
        });
        ...
        Sections.Add(new SettingsSection
        {
            ...
            IconUri = "pack://application:,,,/Mithril;component/Resources/about.ico",
        });
